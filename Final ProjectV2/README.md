...
- `tokenizer_updated.py`: recognizes new keywords
- `parser_updated.py`: parses `apikey`, `mode`, `callMode(...)` logic
- `evaluator_updated.py`: evaluates new features + dispatches modes
- `runner_updated.py`: CLI & REPL logic
